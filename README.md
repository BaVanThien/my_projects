...
**Key skills:** Bare-metal drivers, I2C, SPI, UART DMA, EXTI interrupt, Timer, Logic Analyzer debugging
...
**Key skills:** ARM GCC toolchain, Makefile, Linker Script, Startup code, Memory layout, VS Code + MSYS2
...
- 📧 Email: bavanthien0201@gmail.com
- 🐙 GitHub: [github.com/BaVanThien](https://github.com/BaVanThien)
